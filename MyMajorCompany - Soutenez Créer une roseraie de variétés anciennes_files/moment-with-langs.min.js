...
(function (factory) {
    ...
    function processFutureTime(string){
        if (string.indexOf("heure") > -1){
            return '<span>'+string+'</span>' + ' restante(s)';
        } else {
            return '<span>'+string+'</span>' + ' restant(s)';
        }
    }
